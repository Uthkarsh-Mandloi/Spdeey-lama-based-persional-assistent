...
for i in range(1):
    print("Wait you quiz is loading.....")
    time.sleep(3)
for i in range(1):
    print("loading.....")
    time.sleep(4)
...
for i in range(1):
    ...
    time.sleep(4)
print("Go....")
print("\n\t\t OK ",player_name," Let's Start The Game")
time.sleep(1)
